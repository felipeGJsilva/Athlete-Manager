    ...
    const [message, setMessage] = useState(null);
      ...
      function Atletas() {
        ...
        const deleteAtleta = async (id) => {
          ...
          } catch (err) { alert('Erro ao deletar atleta: ' + err.message); }
        };
            ...
            <form onSubmit={handleSubmit} className="mb-4">
              <div className="row g-2">
                <div className="col-md-3">
                  <input name="nome" value={form.nome} onChange={handleChange} className="form-control" placeholder="Nome" required />
                </div>
                <div className="col-md-2">
                  <input name="esporte" value={form.esporte} onChange={handleChange} className="form-control" placeholder="Esporte" />
                </div>
                <div className="col-md-2">
                  <input name="posicao" value={form.posicao} onChange={handleChange} className="form-control" placeholder="Posição" />
                </div>
                <div className="col-md-1">
                  <input name="idade" value={form.idade} onChange={handleChange} className="form-control" placeholder="Idade" />
                </div>
                <div className="col-md-2">
              ...
              <div className="mt-3">
                <button className="btn btn-gold" disabled={saving}>{saving ? 'Salvando...' : 'Cadastrar Atleta'}</button>
              </div>
            </form>
